        ...
        return (
            <form style={style} onSubmit={this.props.handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <input name ='repeatPassword' type="password" className="form-control" value={this.props.repeatPassword} onChange={this.props.handleChange} placeholder="Repeat Password" />
                </div>
...
export default FormManager(Register,user.register)